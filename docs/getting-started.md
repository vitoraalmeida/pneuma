...
replacing `v0.4.3` with the target immutable tag:

```bash
bash /home/pneuma/pneuma/scripts/update-pneuma.sh --ref v0.4.3
```
...
ssh root@<host> 'bash /tmp/update-pneuma.sh --ref v0.4.3'
```
